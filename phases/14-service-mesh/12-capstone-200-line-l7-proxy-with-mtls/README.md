# 12. Capstone: 200-line L7 proxy with mTLS

## 1. Problem

This capstone brings together everything from the Service Mesh & Cloud-Native phase into a single working project. You will build a complete, functional implementation of 200-line L7 proxy with mTLS that demonstrates mastery of all concepts covered so far.
...
The 200-line L7 proxy with mTLS project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_200line_l7_proxy_with_mtls.c -- Capstone: Capstone: 200-line L7 proxy with mTLS
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_200line_l7_proxy_with_mtls capstone_200line_l7_proxy_with_mtls.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: 200-line L7 proxy with mTLS\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: 200-line L7 proxy with mTLS passed.\n");
    return 0;
}
```
