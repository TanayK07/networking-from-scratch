...
1. **★** Parse a hex dump of a real switching tables and mac learning packet and identify every field manually.
...
5. **★★** Write a pcap analyzer that reads capture files and decodes switching tables and mac learning packets with full field breakdown.
