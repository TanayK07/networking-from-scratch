# 18. Capstone: a tiny L2 switch

## 1. Problem

This capstone brings together everything from the Link Layer phase into a single working project. You will build a complete, functional implementation of a tiny L2 switch that demonstrates mastery of all concepts covered so far.
...
The a tiny L2 switch project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_a_tiny_l2_switch.c -- Capstone: Capstone: a tiny L2 switch
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_a_tiny_l2_switch capstone_a_tiny_l2_switch.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: a tiny L2 switch\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: a tiny L2 switch passed.\n");
    return 0;
}
```
