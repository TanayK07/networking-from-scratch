...
1. **★** Parse a hex dump of a real epoll multithread/multiprocess gotchas packet and identify every field manually.
...
5. **★★** Write a pcap analyzer that reads capture files and decodes epoll multithread/multiprocess gotchas packets with full field breakdown.
