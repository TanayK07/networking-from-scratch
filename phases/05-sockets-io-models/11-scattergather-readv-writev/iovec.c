...
int nfs_iov_scatter(const struct nfs_iovec *iov, int iovcnt,
...
int nfs_iov_gather(const struct nfs_iovec *iov, int iovcnt,
...
int nfs_iov_format(const struct nfs_iovec *iov, int iovcnt,
...
int nfs_iov_find_byte(const struct nfs_iovec *iov, int iovcnt,
                      size_t byte_index, int *iov_idx, size_t *offset)
{
