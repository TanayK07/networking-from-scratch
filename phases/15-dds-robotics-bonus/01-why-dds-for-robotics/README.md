...
1. **★** Parse a hex dump of a real why dds for robotics packet and identify every field manually.
...
5. **★★** Write a pcap analyzer that reads capture files and decodes why dds for robotics packets with full field breakdown.
