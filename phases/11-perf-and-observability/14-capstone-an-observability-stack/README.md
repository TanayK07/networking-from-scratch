# 14. Capstone: an observability stack

## 1. Problem

This capstone brings together everything from the Performance & Observability phase into a single working project. You will build a complete, functional implementation of an observability stack that demonstrates mastery of all concepts covered so far.
...
The an observability stack project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_an_observability_stack.c -- Capstone: Capstone: an observability stack
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_an_observability_stack capstone_an_observability_stack.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: an observability stack\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: an observability stack passed.\n");
    return 0;
}
```
