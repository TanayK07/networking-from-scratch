# 12. Capstone: ship lvl-ip-rebuilt

## 1. Problem

This capstone brings together everything from the Userspace TCP/IP Stack phase into a single working project. You will build a complete, functional implementation of ship lvl-ip-rebuilt that demonstrates mastery of all concepts covered so far.
...
The ship lvl-ip-rebuilt project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_ship_lvliprebuilt.c -- Capstone: Capstone: ship lvl-ip-rebuilt
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_ship_lvliprebuilt capstone_ship_lvliprebuilt.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: ship lvl-ip-rebuilt\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: ship lvl-ip-rebuilt passed.\n");
    return 0;
}
```
