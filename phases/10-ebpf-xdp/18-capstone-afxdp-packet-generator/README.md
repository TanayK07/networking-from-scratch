# 18. Capstone: AF_XDP packet generator

## 1. Problem

This capstone brings together everything from the eBPF, XDP, and Kernel Bypass phase into a single working project. You will build a complete, functional implementation of AF_XDP packet generator that demonstrates mastery of all concepts covered so far.
...
The AF_XDP packet generator project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_afxdp_packet_generator.c -- Capstone: Capstone: AF_XDP packet generator
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_afxdp_packet_generator capstone_afxdp_packet_generator.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: AF_XDP packet generator\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: AF_XDP packet generator passed.\n");
    return 0;
}
```
