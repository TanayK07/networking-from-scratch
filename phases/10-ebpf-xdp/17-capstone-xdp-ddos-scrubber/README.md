# 17. Capstone: XDP DDoS scrubber

## 1. Problem

This capstone brings together everything from the eBPF, XDP, and Kernel Bypass phase into a single working project. You will build a complete, functional implementation of XDP DDoS scrubber that demonstrates mastery of all concepts covered so far.
...
The XDP DDoS scrubber project integrates multiple components built in previous lessons. The architecture follows a layered design where each module handles one responsibility:
...
```c
/*
 * capstone_xdp_ddos_scrubber.c -- Capstone: Capstone: XDP DDoS scrubber
 *
 * Architecture:
 ...
 *
 * Compile: gcc -Wall -O2 -o capstone_xdp_ddos_scrubber capstone_xdp_ddos_scrubber.c -lpthread
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
{
    printf("Capstone: XDP DDoS scrubber\n");
...
int main(void)
{
    ...
    test_empty_payload();
    printf("All tests for Capstone: XDP DDoS scrubber passed.\n");
    return 0;
}
```
