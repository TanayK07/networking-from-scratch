...
int main(void)
{
    ...
    int tlen = nfs_ipip_encapsulate(htonl(0x0A000001), htonl(0x0A000002),
                                    128, inner, sizeof(inner),
    ...
    uint8_t gre_buf[128];
    int glen = nfs_gre_encapsulate(NFS_GRE_FLAG_K | NFS_GRE_FLAG_S,
                                   NFS_GRE_PROTO_IPV4,
                                   42, 1,
                                   payload, sizeof(payload),
                                   gre_buf, sizeof(gre_buf));
