...
{
    switch (r) {
    case NFS_FR_NORMAL:          return "NORMAL";
    case NFS_FR_FAST_RETRANSMIT: return "FAST_RETRANSMIT";
    case NFS_FR_RECOVERY_EXIT:   return "RECOVERY_EXIT";
...
int main(void)
{
    ...
    printf("ACK 10000: %s, cwnd=%u, in_recovery=%d\n",
           result_str(r), nfs_fr_cwnd(&fr), nfs_fr_in_recovery(&fr));
