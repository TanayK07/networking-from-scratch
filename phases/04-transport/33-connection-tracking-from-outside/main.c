...
int main(void)
{
    ...
    /* ACK: client -> server */
    struct nfs_ct_packet ack = {
        .src_ip = 0x0A000001, .dst_ip = 0x0A000002,
        .src_port = 12345, .dst_port = 80,
        .protocol = 6, .tcp_flags = NFS_CT_TCP_ACK,
        .length = 52
    };
