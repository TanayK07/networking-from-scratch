...
where:
  ...
  K = (W_max * beta / C)^(1/3)   (time to reach W_max again after loss)
  W_max = window size at last loss event
...
1. **\u2605** Parse a hex dump of a real tcp cubic packet and identify every field manually.
...
5. **\u2605\u2605** Write a pcap analyzer that reads capture files and decodes tcp cubic packets with full field breakdown.
